...
# Carga de archivos CSV de WOS
st.subheader("Carga de archivos CSV de WOS")
uploaded_files_wos = st.file_uploader("Selecciona uno o varios archivos de WOS (CSV)", type=["csv"], accept_multiple_files=True, key="wos")
