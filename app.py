...
# Carga de archivos TXT de WOS
st.subheader("Carga de archivos TXT de WOS")
uploaded_files_wos = st.file_uploader("Selecciona uno o varios archivos de WOS (TXT)", type=["txt"], accept_multiple_files=True, key="wos")
