...
uploaded_files_scopus = st.file_uploader("Selecciona uno o varios archivos de Scopus (CSV)", type=["csv"], accept_multiple_files=True, , key="scopus_1")

uploaded_files_wos = st.file_uploader("Selecciona uno o varios archivos de WOS (TXT)", type=["txt"], accept_multiple_files=True, , key="wos_1")
...
if 'dfwos' in locals() and not dfwos.empty:
...
uploaded_files_scopus = st.file_uploader("Selecciona uno o varios archivos de Scopus (CSV)", type=["csv"], accept_multiple_files=True, , key="scopus_2")
